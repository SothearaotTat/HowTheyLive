...
#reading data
AUT <- read.csv("AUT data.csv") #main data
variables <- read.csv("acitivities_var.csv")
...
#Import variables 
Recreation_code <- read.csv("recreation_code.csv")
...
ui <- fluidPage(shinytheme("paper"),
   ...
   navbarPage( "How They Live",
     #panel 1
     tabPanel("Time Spent by Activities and Age Groups",id = "panel1",
      fluidRow(
        column(2,
          wellPanel(
        ...
        column(10,
          mainPanel(
            plotOutput("activity_plot", height = "800px")))
          ),
      tags$style(HTML(".shiny-plot-output {
          height: 800px;  
          width: 100%;    
        }
        .container {
...
server <- function(input, output) {
  ...
  labs(
    ...
    subtitle = "The ***American Time Use Survey*** provides a *“summary data”* containing more than 240,000 observsations with 456 variables across a<br>21-year period on how participants spent a day in their lives. This plot presents the distributions of hours spent on 6 main activities<br>featuring different age groups."
